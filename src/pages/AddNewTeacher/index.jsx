      ...
      <div className="bg-gray-100 flex flex-col font-poppins items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-[50px] items-start justify-between mx-auto md:px-5 w-full">
          ...
          >
            ...
            {!collapsed && (
              <Text
                className="mb-[417px] md:ml-[0] ml-[34px] mr-[123px] mt-[15px] text-sm text-white-A700"
          ...
          <div className="flex flex-1 flex-col gap-10 items-start justify-start w-full">
            ...
            <div className="bg-white-A700 flex flex-col items-center justify-start pb-[57px] rounded-[20px] w-full">
              <div className="flex flex-col gap-[31px] justify-start w-full">
                ...
                <div className="flex flex-col gap-6 items-start justify-start ml-10 md:ml-[0] w-[87%] md:w-full">
                  ...
                  <div className="flex md:flex-col flex-row gap-[39px] items-start justify-start w-[67%] md:w-full">
                    <div className="flex flex-col gap-4 items-start justify-start w-auto md:w-full">
                      ...
                      <div className="flex flex-col gap-[11px] items-end justify-start w-full">
                        <div className="bg-white-A700 border border-indigo-100 border-solid flex md:flex-col flex-row font-poppins gap-[7px] items-start justify-end p-1 rounded-[5px] w-full">
                          <Text
                            className="sm:flex-1 md:mt-0 my-[9px] text-gray-500 text-sm w-[97%] sm:w-full"
                            size="txtPoppinsRegular14Gray500"
                          >
                          ...
                          <Line className="bg-gray-100_01 md:h-0.5 h-[70px] mb-[87px] md:mt-0 mt-2 w-0.5 md:w-full" />
                        </div>
                        <Text
            ...
            <div className="bg-white-A700 flex flex-col items-center justify-start pb-10 rounded-[20px] w-full">
              <div className="flex flex-col gap-8 justify-start w-full">
                ...
                <div className="flex flex-col gap-[23px] items-center justify-start ml-10 md:ml-[0] w-[87%] md:w-full">
                  <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                    <div className="flex md:flex-1 flex-col gap-4 items-start justify-start w-auto md:w-full">
                      <Text
                        className="text-indigo-900 text-lg w-auto"
                  ...
                  <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                    <div className="flex md:flex-1 flex-col gap-4 items-start justify-start w-auto md:w-full">
                      ...
                      <div className="flex md:flex-col flex-row gap-6 items-start justify-start w-auto md:w-full">
                        <Input
                          name="septemberCounter"
                          placeholder="September 2013"
                          className="leading-[normal] p-0 placeholder:text-gray-500 text-left text-sm w-full"
                          wrapClassName="border border-indigo-100 border-solid w-[48%] md:w-full"
                          shape="round"
                          color="white_A700"
                          variant="fill"
                        ></Input>
                        <Input
                          name="septemberCounter_One"
            ...
            <div className="flex flex-row gap-[26px] items-center justify-end md:ml-[0] ml-[1167px] w-[21%] md:w-full">
              <Button
